...
namespace CheckShort_YC4.Business
{
    public static class StringExtension
    {
        ...
        public static bool IsYaskawa(this string customerID)
        {
            if (customerID.IsNullOrBlank())
            {
                return false;
            }
            return string.Equals(customerID, "CS045", StringComparison.OrdinalIgnoreCase);
        }
        public static bool IsNewSheet(this string comRecei)
        {
            return (!comRecei.IsNullOrBlank() && comRecei == Entities.Settings.Option.SignalReady);
        }
    }
}
